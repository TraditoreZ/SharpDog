...
namespace Server.Lib
{
    ...
    public class IOCPServer : NetWork, IDisposable,ICallBack
    {
        ...
        private Dictionary<Object, PearBase> pear;
        ...
        public IOCPServer(IPAddress localIPAddress, int listenPort, int maxClient)
        {
            ...
            pear = new Dictionary<Object, PearBase>();
        }
        ...
        private void StartAccept(SocketAsyncEventArgs asyniar)
        {
            ...
            _maxAcceptedClients.WaitOne(100);
            ...
            if (e.SocketError == SocketError.Success)
            {
                ...
                if (s.Connected)
                {
                    try
                    {
                        ...
                        //自定义客户
                        PearBase pearBase = Program.application.CreatePear();
                        pear.Add(s, pearBase);
                        pearBase.SetSocketEvent(e);
